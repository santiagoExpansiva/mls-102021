/// <mls fileReference="_102021_/l2/agentEndpointLayer4Entity.ts" enhancement="_blank" />
...
export function createAgent(): IAgent {
    return {
        ...
        agentDescription: "Agent agentEndpointLayer4Entity, for create entity",
        visibility: "private",
...
const _beforePrompt = async (context: mls.msg.ExecutionContext): Promise<void> => {
    ...
    if (!context.task) {
        let prompt = context.message.content.replace('@@agentEndpointLayer4Entity', '').trim();
...
async function nextStep(context: mls.msg.ExecutionContext) {
    ...
    const newStep: mls.msg.AIPayload = {
        agentName: 'agentEndpointLayer4EntityBase',
        prompt: 'ok',
        status: 'pending',
    ...
    return await addNewStep(context, step.stepId, [newStep]);
